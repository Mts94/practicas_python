...
def rentas():
    ...
    if (renta < 10000):
        a = 'El tipo impositivo que le toca es el 5%'
    elif (renta >= 10000 and renta <= 20000):
        a = 'El tipo impositivo que le correnponde es del 15%'
    elif (renta >= 20000 and renta <= 35000):
        a = 'El tipo de impositivo que le corresponde es del 20%'
    elif (renta >= 35000 and renta <= 60000):
        a = 'El tipo impositivo que le corresponde es del 30%'
    else:
        a = 'El tipo impositivo que le corresponde es del 45%'
